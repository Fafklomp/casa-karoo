    ...
    >
      ...
      >
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="text-[10px] md:text-xs leading-relaxed text-stone/80 mb-8 mt-6 text-justify">
            {project.id === 1 ? (
          ...
          {project.id === 99 && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Img src="/projects/house-euphorbia/03.png" alt="House Euphorbia concept 1" className="w-full h-auto rounded-sm" />
                <div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                <Img src="/projects/house-euphorbia/05.png" alt="House Euphorbia concept 3" className="w-full h-auto rounded-sm" />
                <div>
                  <Img src="/projects/house-euphorbia/07.png" alt="House Euphorbia concept 4" className="w-full h-auto rounded-sm" />
              ...
              <div className="grid grid-cols-2 gap-2 mt-2">
                ...
                <div>
                  ...
                  <p className="text-xs font-light italic mt-1 text-right" style={{ color: '#8A9EBA' }}>Fireplace</p>
                </div>
              </div>
            </div>
          )}
          ...
          {project.id === 2 && (
            <div className="mb-8">
              ...
              <p className="text-xs tracking-wide lowercase font-light italic mt-6" style={{ color: '#C4A882' }}>perspectives</p>
              <PerspBanner />
              <p className="text-xs tracking-wide lowercase font-light italic mt-8" style={{ color: '#C4A882' }}>Look &amp; Feel</p>
              ...
              <p className="text-[9px] font-light text-stone/35 italic mt-1">ground floor plan - NTS</p>
              <p className="text-xs tracking-wide lowercase font-light italic mt-6" style={{ color: '#C4A882' }}>Materiality</p>
              ...
              <p className="text-xs tracking-wide lowercase font-light italic mt-6" style={{ color: '#C4A882' }}>Bedroom</p>
          ...
          {project.id === 1 && (
            <div className="mb-8">
              <p className="text-xs tracking-wide lowercase font-light italic mb-1" style={{ color: '#C4A882' }}>Floor Plan</p>
              <p className="text-xs text-stone/40 italic mb-3">(concealed for confidentiality purposes)</p>
              <svg viewBox="0 0 9693 4374" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto rounded-sm" style={{fontFamily:"'Inter', system-ui, sans-serif"}}>
          ...
          {project.id === 1 && (
            <div className="mb-8">
              <p className="text-xs tracking-wide lowercase font-light italic mb-2" style={{ color: '#C4A882' }}>Materiality</p>
          ...
          {project.id === 1 && (
            <div className="mb-8">
              ...
              <p className="text-xs italic mb-4 ml-4" style={{ color: '#C4A882' }}>Double treatment room</p>
          ...
          {project.id === 1 && (
            <div className="mb-8">
              ...
              <p className="text-xs italic mb-4 ml-4" style={{ color: '#C4A882' }}>Changeroom 01</p>
          ...
          {project.id === 1 && (
            <div className="mb-8">
              ...
              <p className="text-xs italic mb-4 ml-4" style={{ color: '#C4A882' }}>Changeroom 02</p>
          ...
          {project.id === 1 && (
            <div className="mt-5">
              <a
                ...
                className="inline-flex items-center gap-2 text-xs tracking-wide lowercase text-stone/70 hover:text-stone/90 transition-colors duration-150 bg-[#C4A882]/20 hover:bg-[#C4A882]/35 px-3 py-1.5 rounded-sm"
              >
                View More
                <MdTouchApp size={16} style={{ color: '#C4A882' }} />
              </a>
            </div>
          )}
